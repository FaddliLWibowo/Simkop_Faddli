    ...
    <div id="myTabContent" class="tab-content">
        ...
        <div class="control-group">
			...
			<div class="controls">
			  ...
			  <input type="text" class="span6" name="no_ba" id="no_ba" value="<?php echo $no_ba; ?>" placeholder="NIP">
		...
		<div class="control-group">
			...
			<div class="controls">
				<input type="text" class="span6" name="no_ktp" id="no_ktp" value="<?php echo $no_ktp; ?>" placeholder="Nama Lengkap"></div>
			</div>
		</div>	
		<div class="control-group">
		 ...
		 <div class="control-group">
		  ...
		  <div class="control-group">
			...
			<div class="controls">
				...
				<textarea class="span6" style="outline:none; resize:none;" name="alamat" id="alamat"  placeholder= "Alamat"><?php echo $alamat; ?> </textarea>
		  ...
		  <div class="control-group">
			...
			<div class="controls">
			  ...
			  <input type="text" class="span6" name="lingkungan" id="lingkungan" value="<?php echo $lingkungan; ?>" placeholder="Lingkungan (Kring) / Stasi">
		  ...
		  <div class="control-group">
			...
			<div class="controls">
			  ...
			  <input type="text" class="span6" name="pekerjaan" id="pekerjaan" value="<?php echo $pekerjaan; ?>" placeholder=
			  "Pekerjaan">
		  ...
		  <div class="control-group">
			...
			<div class="controls">
				...
				<input type="text" class="span6" name="nama_suamiisteri" id="nama_suamiisteri" value="<?php echo $nama_suamiisteri; ?>" placeholder=
			  "Nama Suami / Isteri">
		  ...
		  <div class="control-group">
			...
			<div class="controls">
				...
				<input type="text" class="span6" name="orang_tua" id="orang_tua" value="<?php echo $orang_tua; ?>" placeholder=
			  "Orang Tua">
		  ...
		  <div class="control-group">
			...
			<div class="controls">
				...
				<input type="text" class="span6" name="uang_pangkal" id="uang_pangkal" value="<?php echo $uang_pangkal; ?>" placeholder="Rp. 40.000,-"></div>
			</div>
		
		 <div class="control-group">
			<label class="control-label" for="simpanan_wajib">Simpanan Wajib (Simpanan Tiap Bulan)</label>
			<div class="controls">
				<input type="text" class="span6" name="simpanan_wajib" id="simpanan_wajib" value="<?php echo $simpanan_wajib; ?>" placeholder="Rp. 20.000,-"></div>
			</div>
		
		 <div class="control-group">
			<label class="control-label" for="simpanan_pokok">Simpanan Pokok</label>
			<div class="controls">
				<input type="text" class="span6" name="simpanan_pokok" id="simpanan_pokok" value="<?php echo $simpanan_pokok; ?>" placeholder="Rp. 200.000,-"></div>
			</div>
			
		<div class="control-group">
			<label class="control-label" for="iuran_sumbangan">Iuran Sumbangan Wajib Duka Anggota</label>
			<div class="controls">
				<input type="text" class="span6" name="iuran_sumbangan" id="iuran_sumbangan" value="<?php echo $iuran_sumbangan; ?>" placeholder="Rp. 50.000,-"></div>
			</div>
		
		<div class="control-group">
			<label class="control-label" for="simpanan_sukarela">Simpanan Sukarela (Minimal Rp. 1000,-) </label>
			<div class="controls">
				<input type="text" class="span6" name="simpanan_sukarela" id="simpanan_sukarela" value="<?php echo $simpanan_sukarela; ?>" placeholder="Rp. 50.000,-"></div>
			</div>
