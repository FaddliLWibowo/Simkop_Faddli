...
<html lang="en">
  ...
  <body>
	...
	<?php echo form_open_multipart('master_pegawai_koperasi/index','class="form-horizontal"'); ?>
    ...
    <div id="myTabContent" class="tab-content">
        ...
        <div class="control-group">
			...
			<div class="controls">
			  ...
			  <input type="text" disabled class="span6" name="nip" id="nip" value="<?php echo $nip; ?>" placeholder="NIP">
		...
		<div class="control-group">
		  <label class="control-label" for="jenis_kelamin">Jenis Kelamin</label>
			<div class="controls">
				<select data-placeholder="Jenis Kelamin" disabled class="chzn-select" style="width:500px;" tabindex="2" name="jenis_kelamin" id="jenis_kelamin">
					<?php
		 ...
		 <div class="control-group">
		  ...
		  <div class="control-group">
			...
			<div class="controls">
				...
				<textarea class="span6" disabled style="outline:none; resize:none;" name="alamat_lengkap" id="alamat_lengkap"  placeholder= "Alamat"><?php echo $alamat_lengkap; ?> </textarea>
			...
			<div class="controls">
			<select data-placeholder="Jabatan" disabled class="chzn-select" style="width:500px;" tabindex="2" name="id_jabatan" id="id_jabatan">
			<option value=""></option>
			  	<?php
