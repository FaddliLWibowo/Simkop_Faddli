...
<html lang="en">
  ...
  <div class="well">
	<div class="navbar navbar-inverse">
	  <div class="navbar-inner">
		<div class="container">
		  <a class="brand" href="#">Daftar Pegawai</a>
		  <div class="nav-collapse">
			<ul class="nav">
			  <li><a href="<?php echo base_url(); ?>master_pegawai_koperasi/tambah" class="medium-box"><i class="icon-plus-sign icon-white"></i> Tambah Pegawai</a></li>
			</ul>
		  </div>
		<div class="span6 pull-right">
		<?php echo form_open("master_pegawai_koperasi/cari", 'class="navbar-form pull-right"'); ?>
  ...
  <table class="table table-hover table-condensed">
	...
	?>
      <tr>
		...
		<td>
	        <div class="btn-group">
	          <a class="btn btn-small" href="<?php echo base_url(); ?>master_pegawai_koperasi/detail/<?php echo $dp['nip']; ?>"><i class="icon-ok-circle"></i> Lihat Detail</a>
	          <a class="btn btn-small dropdown-toggle" data-toggle="dropdown" href="#"><span class="caret"></span></a>
	          <ul class="dropdown-menu">
	            <li><a href="<?php echo base_url(); ?>master_pegawai_koperasi/edit/<?php echo $dp['nip']; ?>"><i class="icon-pencil"></i> Edit Data</a></li>
	            <li><a href="<?php echo base_url(); ?>master_pegawai_koperasi/hapus/<?php echo $dp['nip']; ?>" onClick="return confirm('Anda yakin..???');"><i class="icon-trash"></i> Hapus Data</a></li>
	          </ul>
	        </div><!-- /btn-group -->
		</td>
      </tr>
