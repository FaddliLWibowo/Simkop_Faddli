	  ...
	  <div class="navbar-inner">
		<div class="container">
		  ...
		  <div class="nav-collapse">
			<ul class="nav">
			  <li><a href="<?php echo base_url(); ?>anggota/cetak_laporan_bayar" class="medium-box"><i class="icon-tasks icon-white"></i> Cetak Laporan Anggota</a></li>
			</ul>
		  </div>
		<div class="span6 pull-right">
		<?php
			echo form_open("anggota/cetak_bayar",'class="navbar-form pull-right"');
		?>
  ...
  <table class="table table-hover table-condense">
	...
	?>
      <tr>
        ...
        <td><?php echo $dp['simpanan_pokok']; ?></td>
        <td><?php echo $dp['simpanan_wajib']; ?></td>
        <td><?php echo $dp['simpanan_sukarela']; ?></td>
        <td><?php echo $dp['uang_pangkal']; ?></td>
