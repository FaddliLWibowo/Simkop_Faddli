  ...
  <body>
	...
	<?php } ?>
      <div class="hero-unit">
        ...
        <p>Sistem Informasi Pendaftaran Koperasi merupakan sebuah aplikasi untuk melakukan manajemen data anggota koperasi KSP KOPDIT PELITA HATI a FATIMA di pekanbaru. Silahkan masukkan username dan password anda untuk mulai untuk melakukan manajemen atau pengolahan data anggota sesuai dengan hak akses yang anda miliki.</p>
